...
test_data=pd.read_csv(r"",encoding_errors='ignore')

with open('EntireMLP_model.pkl', 'rb') as f:
    MLP_model = pickle.load(f)


with open('XGB2EntireFileModel.pkl','rb') as f:
    XGB_model =pickle.load(f)

with open('EntireSVMmodel.pkl','rb') as f:
    SVM_model=pickle.load(f)


with open('EntireFileVectorizer.pkl', 'rb') as f:
    vectorizer = pickle.load(f)

with open('EntireHybrid_MLP.pkl','rb') as f:
    Hybrid_MLP=pickle.load(f)



with open('Entire_Hybrid_XGB.pkl','rb') as f:
...
X_test= vectorizer.transform(X_test['text'].squeeze())
...
Hybrid_prob_pred=Hybrid_MLP.predict_proba(X_test)
...
plt.title('\'Entire File\' ROC Curve')
