...
#model_eval = BertForSequenceClassification.from_pretrained('neulab/codebert-c')
# Count total number of parameters in the CodeBERT model



# Load the configuration
config_path = "./results/checkpoint-27500/config.json"
config = AutoConfig.from_pretrained(config_path)

# Load the model weights
weights_path = "./results/checkpoint-27500/pytorch_model.bin"
...
train_df = pd.read_csv("synthetic_data.csv")
